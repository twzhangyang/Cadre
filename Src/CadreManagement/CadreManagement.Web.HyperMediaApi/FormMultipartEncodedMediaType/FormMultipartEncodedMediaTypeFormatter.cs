...
using CadreManagement.Web.HyperMediaApi.FormMultipartEncodedMediaType.Converters;
using CadreManagement.Web.HyperMediaApi.FormMultipartEncodedMediaType.Logger;

namespace CadreManagement.Web.HyperMediaApi.FormMultipartEncodedMediaType
{
