...
namespace CadreManagement.Web.HyperMediaApi
{
    ...
    {
        //public static Link<TResource> HttpLink<TController, TResource>(this UrlHelper @this, Expression<Func<TController, TResource>> actionSelector) where TController : Controller
        //{
        //    return new Link<TResource>(GenerateHttpLinkUrl<TController>(@this, actionSelector));
        //}

        //private static string GenerateHttpLinkUrl<TController>(UrlHelper @this, LambdaExpression actionSelector) where TController : Controller
        //{
